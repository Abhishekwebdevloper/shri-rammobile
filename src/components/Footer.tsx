      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="pt-8 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-zinc-500">
          ...
          <div className="flex items-center gap-4">
             <a href="tel:+919595905650" className="hover:text-white transition-colors">Call</a>
             <span>•</span>
             <a href="https://wa.me/919595905650?text=Hi" target="_blank" rel="noreferrer" className="hover:text-white transition-colors">WhatsApp</a>
             <span>•</span>
